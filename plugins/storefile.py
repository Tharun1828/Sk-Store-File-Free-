...
async def storefile(c, m):
    ...
    # creating urls
    bot = await c.get_me()
    url = f"https://telegram.me/{bot.username}?start={m.chat.id}_{m.message_id}" if not DB_CHANNEL_ID else f"https://telegram.me/{bot.username}?start={m.chat.id}_{msg.message_id}"
